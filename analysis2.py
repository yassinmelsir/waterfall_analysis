...
def exit_dist(valuation):
    ...
    # at valulations of more than or equal to 31.5m A will always cap, A will always LP until 43.5 where CS start too outpace LPs
        ...
        # a cap, b cs, C lps
        # scTw_payout_ammount = payout_ammount-cap_Table['c']['invested']-cap_Table['a']['invested']*2
        # scTw_shares = total_shares-cap_Table['a']['shares']
        # scenario_Two = [cap_Table['c']['invested']+scTw_payout_ammount*(c_shares/scTw_shares), (scTw_payout_ammount)*(b_shares/scTw_shares), a_cap, (scTw_payout_ammount)*(com_shares/scTw_shares)]
        # print('a cap, b cs, C lps: ', scenario_Two)
         # a cs, b cap, C lps
        # scT_payout_ammount = payout_ammount-cap_Table['c']['invested']-cap_Table['b']['invested']*2
        # scT_shares = total_shares-cap_Table['b']['shares']
        # scenario_Two = [cap_Table['c']['invested']+scT_payout_ammount*(c_shares/scT_shares), b_cap, (scT_payout_ammount)*(a_shares/scT_shares), (scT_payout_ammount)*(com_shares/scT_shares)]
        # print('a cs, b cap, C lps: ', scenario_Two)
        # a cs, b cs, C lps
        # scF_payout_ammount = payout_ammount-cap_Table['c']['invested']
        # scO_shares = total_shares
        # scenario_Two = [cap_Table['c']['invested']+scF_payout_ammount*(c_shares/scO_shares), (scF_payout_ammount)*(b_shares/scO_shares), (scF_payout_ammount)*(a_shares/scO_shares), (scF_payout_ammount)*(com_shares/scO_shares)]
        # print('C LP, B and A CS: ', scenario_Two)
        ...
        # scT_payout_ammount = payout_ammount-cap_Table['c']['invested']-cap_Table['b']['invested']
        # scT_shares = total_shares
        # scenario_Two = [cap_Table['c']['invested']+scT_payout_ammount*(c_shares/scT_shares), cap_Table['b']['invested']+scT_payout_ammount*(b_shares/scT_shares), scT_payout_ammount*(a_shares/scT_shares), (scT_payout_ammount)*(com_shares/scT_shares)]
